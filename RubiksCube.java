...
class RubiksCube {
    ...
    void scrambleOrange() {
        ...
        for (int i = 0; i < 9; i++) {
            if (i == 4)
                continue;
            Tile tile = orangeFace.getTiles().get(i);
            boolean canSetColor = false;
            float r = 0;
            float g = 0;
            float b = 0;
    ...
    void scrambleBlue() {
        ...
        for (int i = 0; i < 9; i++) {
            if (i == 4)
                continue;
            Tile tile = blueFace.getTiles().get(i);
            boolean canSetColor = false;
            float r = 0;
            float g = 0;
            float b = 0;
    ...
    void scrambleYellow() {
        ...
        for (int i = 0; i < 9; i++) {
            if (i == 4)
                continue;
            Tile tile = yellowFace.getTiles().get(i);
            boolean canSetColor = false;
            float r = 0;
            float g = 0;
            float b = 0;
    ...
    void scrambleRed() {
        ...
        for (int i = 0; i < 9; i++) {
            if (i == 4)
                continue;
            Tile tile = redFace.getTiles().get(i);
            boolean canSetColor = false;
            float r = 0;
            float g = 0;
            float b = 0;
    ...
    void scrambleGreen() {
        ...
        for (int i = 0; i < 9; i++) {
            if (i == 4)
                continue;
            Tile tile = greenFace.getTiles().get(i);
            boolean canSetColor = false;
            float r = 0;
            float g = 0;
            float b = 0;
